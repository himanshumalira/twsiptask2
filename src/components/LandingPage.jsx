...
function LandingPage() {
  return <div className=' w-full h-screen bg-zinc-900 pt-1'>
           ...
           {["We Create", "Eye Opening", "Presentations"].map((item, index) => {
            ...
            <div className='masker'>
              <div className=' w-fit flex items-end overflow-hidden '>
                {index === 1 && (<div className=' mr-[1vw] w-[8vw] rounded-md h-[5.7vw] relative -top-[1.2vw] bg-red-500'></div>)}
            <h1 className=' pt-[2vw] -mb-[1vw] uppercase text-[9vw] leading-[8vw] font-["Test_Founders_Grotesk_x-Condensed"] font-bold '>
                {item}
            </h1>
            </div>
            </div>
